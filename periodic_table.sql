...
--
-- Name: properties atomic_pkey; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT atomic_pkey FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);
